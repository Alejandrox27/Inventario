...
class Ui_ProductoBuscar(object):
    def setupUi(self, ProductoBuscar):
        ...
        ProductoBuscar.resize(320, 188)
        ProductoBuscar.setMinimumSize(QtCore.QSize(320, 188))
        ProductoBuscar.setMaximumSize(QtCore.QSize(320, 188))
        ...
        self.lay_frm_busqueda.setHorizontalSpacing(30)
        ...
        self.chk_disponible.setCheckable(True)
        self.chk_disponible.setChecked(False)
    ...
    def retranslateUi(self, ProductoBuscar):
        ...
        ProductoBuscar.setWindowTitle(_translate("ProductoBuscar", "Buscar Producto"))
        self.lbl_codigo.setText(_translate("ProductoBuscar", "Codigo: "))
