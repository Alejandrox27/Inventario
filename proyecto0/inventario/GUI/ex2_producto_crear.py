...
class Ui_ProductoCrear(object):
    def setupUi(self, ProductoCrear):
        ...
        self.spx_cantidad = QtWidgets.QSpinBox(ProductoCrear)
        self.spx_cantidad.setObjectName("spx_cantidad")
        self.lay_frm_principal.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.spx_cantidad)
        ...
        ProductoCrear.setTabOrder(self.txt_precio, self.spx_cantidad)
        ProductoCrear.setTabOrder(self.spx_cantidad, self.chk_disponible)
        ProductoCrear.setTabOrder(self.chk_disponible, self.btn_registrar)

    def retranslateUi(self, ProductoCrear):
        _translate = QtCore.QCoreApplication.translate
        ProductoCrear.setWindowTitle(_translate("ProductoCrear", "Crear producto"))
        self.lbl_codigo.setText(_translate("ProductoCrear", "Codigo: "))
